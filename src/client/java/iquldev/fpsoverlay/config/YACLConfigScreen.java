        ...
        return YetAnotherConfigLib.createBuilder()
            ...
            .category(ConfigCategory.createBuilder()
                ...
                .group(OptionGroup.createBuilder()
                    ...
                    .description(OptionDescription.of(Component.translatable("fpsoverlay.group.display.desc")))
                ...
                .group(OptionGroup.createBuilder()
                    ...
                    .option(Option.<InfoOverlayConfig.OverlayPosition>createBuilder()
                        ...
                        .controller(opt -> CyclingListControllerBuilder.create(opt)
                            ...
                            .formatValue(v -> Component.translatable("fpsoverlay.enum.OverlayPosition." + v.name())))
                        .listener((opt, val) -> InfoOverlayConfig.overlayPosition = val)
                        .build())
                    .build())
                .group(OptionGroup.createBuilder()
                    .name(Component.translatable("fpsoverlay.group.media"))
                    .description(OptionDescription.of(Component.translatable("fpsoverlay.group.media.desc")))
                    .option(Option.<Boolean>createBuilder()
                        .name(Component.translatable("fpsoverlay.option.mediaWidgetCompact"))
                        .binding(false, () -> InfoOverlayConfig.mediaWidgetCompact, val -> InfoOverlayConfig.mediaWidgetCompact = val)
                        .controller(BooleanControllerBuilder::create)
                        .listener((opt, val) -> InfoOverlayConfig.mediaWidgetCompact = val)
                        .build())
                    .option(Option.<Integer>createBuilder()
                        .name(Component.translatable("fpsoverlay.option.mediaMaxLineChars"))
                        .binding(36, () -> InfoOverlayConfig.mediaMaxLineChars, val -> InfoOverlayConfig.mediaMaxLineChars = val)
                        .controller(opt -> IntegerSliderControllerBuilder.create(opt).range(8, 80).step(1))
                        .listener((opt, val) -> InfoOverlayConfig.mediaMaxLineChars = val)
                        .build())
                    .option(Option.<Integer>createBuilder()
                        .name(Component.translatable("fpsoverlay.option.mediaCompactMaxChars"))
                        .binding(48, () -> InfoOverlayConfig.mediaCompactMaxChars, val -> InfoOverlayConfig.mediaCompactMaxChars = val)
                        .controller(opt -> IntegerSliderControllerBuilder.create(opt).range(12, 120).step(1))
                        .listener((opt, val) -> InfoOverlayConfig.mediaCompactMaxChars = val)
                        .build())
                    .build())
                .build())
            .category(ConfigCategory.createBuilder()
                ...
                .group(OptionGroup.createBuilder()
                    ...
                    .option(Option.<Boolean>createBuilder()
                        .name(Component.translatable("fpsoverlay.option.isMedia"))
                        .binding(false, () -> InfoOverlayConfig.isOverlayMedia, val -> InfoOverlayConfig.isOverlayMedia = val)
                        .controller(BooleanControllerBuilder::create)
                        .listener((opt, val) -> InfoOverlayConfig.isOverlayMedia = val)
                        .build())
                    .option(Option.<String>createBuilder()
                        ...
                        .description(OptionDescription.of(Component.translatable("fpsoverlay.placeholders.description")))
                        .build())
                    .build())
                ...
                .group(OptionGroup.createBuilder()
                    ...
                    .option(Option.<String>createBuilder()
                        ...
                        .description(OptionDescription.of(Component.translatable("fpsoverlay.option.overlayDynamicDesc")))
            ...
            .category(ConfigCategory.createBuilder()
                ...
                .group(OptionGroup.createBuilder()
                    ...
                    .option(Option.<Boolean>createBuilder()
                        .name(Component.translatable("fpsoverlay.option.isMedia"))
                        .binding(false, () -> InfoOverlayConfig.isAdvancedMedia, val -> InfoOverlayConfig.isAdvancedMedia = val)
                        .controller(BooleanControllerBuilder::create)
                        .listener((opt, val) -> InfoOverlayConfig.isAdvancedMedia = val)
                        .build())
                    .option(Option.<String>createBuilder()
                ...
                .group(OptionGroup.createBuilder()
                    ...
                    .option(Option.<String>createBuilder()
                        ...
                        .description(OptionDescription.of(Component.translatable("fpsoverlay.option.advancedDynamicDesc")))
