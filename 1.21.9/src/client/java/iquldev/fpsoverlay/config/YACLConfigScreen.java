        ...
        return YetAnotherConfigLib.createBuilder()
            ...
            .category(ConfigCategory.createBuilder()
                ...
                .group(OptionGroup.createBuilder()
                    ...
                    .build())
                .group(OptionGroup.createBuilder()
                    .name(Text.translatable("fpsoverlay.group.media"))
                    .description(OptionDescription.of(Text.translatable("fpsoverlay.group.media.desc")))
                    .option(Option.<Boolean>createBuilder()
                        .name(Text.translatable("fpsoverlay.option.mediaWidgetCompact"))
                    ...
                    .option(Option.<Integer>createBuilder()
                        .name(Text.translatable("fpsoverlay.option.mediaMaxLineChars"))
                        ...
                        .build())
                    .option(Option.<Integer>createBuilder()
                        .name(Text.translatable("fpsoverlay.option.mediaCompactMaxChars"))
            ...
            .category(ConfigCategory.createBuilder()
                ...
                .group(OptionGroup.createBuilder()
                    ...
                    .option(Option.<Boolean>createBuilder()
                        .name(Text.translatable("fpsoverlay.option.isMedia"))
