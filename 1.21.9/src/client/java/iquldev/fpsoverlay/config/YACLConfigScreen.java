            ...
            .category(ConfigCategory.createBuilder()
                ...
                .group(OptionGroup.createBuilder()
                    ...
                    .option(Option.<String>createBuilder()
                        ...
                        .description(OptionDescription.of(Text.translatable("fpsoverlay.midnightconfig.overlayDynamicDesc")))
            ...
            .category(ConfigCategory.createBuilder()
                ...
                .group(OptionGroup.createBuilder()
                    ...
                    .option(Option.<String>createBuilder()
                        ...
                        .description(OptionDescription.of(Text.translatable("fpsoverlay.midnightconfig.advancedDynamicDesc")))
